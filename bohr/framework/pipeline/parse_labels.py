...
from bohr.framework import PYTHON_ROOT
from bohr.framework.labels.hierarchies import LabelHierarchy

logger = logging.getLogger(__name__)

PATH_TO_LABELS_DIR = PYTHON_ROOT / "labels"
